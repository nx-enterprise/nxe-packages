...
import { NxDddArchitectureGeneratorSchema } from './schema';

interface NormalizedSchema extends NxDddArchitectureGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
export default async function (tree: Tree, options: NxDddArchitectureGeneratorSchema) {
  ...
  addProjectConfiguration(tree, normalizedOptions.projectName, {
    ...
    targets: {
      build: {
        executor: '@nx-enterprise/nxe-ddd-architecture:build',
      },
    },
